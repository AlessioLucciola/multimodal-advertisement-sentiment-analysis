...
def get_audio_stream():
    try:
        p = pyaudio.PyAudio()
        stream = p.open(format=pyaudio.paFloat32, channels=1, rate=AUDIO_SAMPLE_RATE, input=True, frames_per_buffer=2500, input_device_index=15, output_device_index=14) # Alessio: input_device_index=1, output_device_index=3 | Danilo: input_device_index=15, output_device_index=14
        return stream
