...
VIDEO_FILES_DIR = os.path.join(VIDEO_DATASET_DIR, DATASET_NAME, DATASET_NAME + "_video_files")
FRAMES_FILES_DIR = os.path.join(VIDEO_DATASET_DIR, DATASET_NAME, DATASET_NAME + "_frames_files_black_background") # RAVDESS: _frames_files | _frames_files_black_background
VIDEO_METADATA_CSV = os.path.join(VIDEO_DATASET_DIR, DATASET_NAME, DATASET_NAME + "_metadata_original.csv") 
VIDEO_METADATA_FRAMES_CSV = os.path.join(VIDEO_DATASET_DIR, DATASET_NAME, DATASET_NAME + "_metadata_frames.csv") 
