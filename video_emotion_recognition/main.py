...
def Train(epochs,train_loader,val_loader,criterion,optmizer,device, writer):
    ...
    for e in range(epochs):
        ...
        print('Epoch: {} \tTraining Loss: {:.8f} \tValidation Loss {:.8f} \tTraining Accuarcy {:.3f}% \tValidation Acuuarcy {:.3f}%'
        ...
        if (e+1) % 5 == 0:
                torch.save(net.state_dict(),'checkpoints/deep_emotion-{}-{}-{}_{}.pt'.format(e+1,batchsize,lr,current_datetime))
...
if __name__ == '__main__':
    ...
    if args.train:
        ...
        writer = SummaryWriter('runs/fer2013_experiment_' + current_datetime)
